...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.show_frag, container, false);

        ImageView imageView = (ImageView) root.findViewById(R.id.show_frag_image);
        imageView.setImageResource(getActivity().getIntent().getIntExtra("temp_ID",0));
